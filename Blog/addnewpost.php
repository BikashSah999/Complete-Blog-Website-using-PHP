...
if(isset($_POST['submit']))
{
    ...
    {
        $insert = mysqli_query($con, "INSERT INTO admin_panel(datetime, title, categoryname, author, image, post, views) VALUES ('$datetime','$title','$category','$adminname','$image','$post','0')");
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-2">
                ...
                <li class="nav-item">
                    <a class="nav-link active admin" href="#"><span class="fas fa-list-alt"></span>&nbsp;Add New Post</a>
                </li>
                <li class="nav-item">
            ...
            <div class="col-sm-10">
                ...
                <?php
                if(in_array("Post Added Succesfully",$errormessage)){
