...
if(isset($_POST['submit']))
{
    ...
    if(empty($errormessage))
    {
        ...
        $update = mysqli_query($con, "DELETE FROM admin_panel WHERE id='$deleteid'");
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-10">
                ...
                <form action="deleteblogpost.php?deleteid=<?php echo $_GET['id'];?>" method="post" enctype="multipart/form-data">
